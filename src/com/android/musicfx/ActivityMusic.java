...
public class ActivityMusic extends AppCompatActivity {
    ...
    public void savePreset(String name) {
        ...
        Toast.makeText(getApplicationContext(),name+" has been saved", Toast.LENGTH_SHORT).show();
    }
    ...
    public void loadPreset(String name) {
        ...
        Toast.makeText(getApplicationContext(),name+" has been load", Toast.LENGTH_SHORT).show();
    }
    ...
    private void loadRessourcesFromXmlParser(XmlPullParser parser, String prefLevel) throws XmlPullParserException, IOException {
        ...
        editor.commit();
        Log.e(TAG, "Load preference : "+prefLevel+" performed");
    }
    ...
    private void loadAllXMLFile() throws XmlPullParserException, IOException {
        ...
        loadXMLFile(spDir+packageName+".bluetooth.xml", ControlPanelEffect.BLUETOOTH_PREF_SCOPE); // Bluetooth
        loadXMLFile(spDir+packageName+".headset.xml", ControlPanelEffect.HEADSET_PREF_SCOPE); // Headset
        loadXMLFile(spDir+packageName+".speaker.xml", ControlPanelEffect.SPEAKER_PREF_SCOPE); // Speaker
    }
}
